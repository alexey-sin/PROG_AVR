...
;	Delayus		задержка высокой точности в несколько дес€тков микросекунд
...
; RCALL дает 3 + 1 NOP + 4 RET = 8 - 1 микросекунда при 8ћ√ц
Delay1us:							
	NOP			
RET
;=================================================	
...
RET
;=================================================		
; задержка высокой точности в несколько дес€тков микросекунд
;	вход Temp1 количество необходимых дес€тков микросекунд
Delayus:
	PUSH	Temp2
Delayus_loop1:
	LDI		Temp2, 25
