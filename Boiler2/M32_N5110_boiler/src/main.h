...
#include "../../../_lib_tft_st7735/tft_st7735.h"
// #include "Font 6x8.c"
...
const char* LabelT1 PROGMEM = "T1: ";
const char* LabelT2 PROGMEM = "T2: ";
const char* LabelT3 PROGMEM = "T3: ";
const char* LabelM1 PROGMEM = "М1: ";
const char* LabelM2 PROGMEM = "М2: ";
const char* LabelM3 PROGMEM = "М3: ";
const char* LabelUNC PROGMEM = "UNC";
const char* LabelBRK PROGMEM = "BREAK";
const char* LabelOVR PROGMEM = "OVER";
const char* LabelERR PROGMEM = "ERROR";
const char* LabelSetting PROGMEM = "Настройка";
//===============================================================================
const char* Label_TEMP PROGMEM = "Температура";
const char* Label_ROOM PROGMEM = "помещения";
const char* Label_DELTA_TEMP PROGMEM = "Дельта темп.";
const char* Label_TOP_OVEN PROGMEM = "поверхн. печи";
const char* Label_START_PYROLYS PROGMEM = "старта пирол.";
const char* Label_FULL_PYROLYS PROGMEM = "полный пирол.";
const char* Label_RAZN_TEMP PROGMEM = "Разность тем.";
const char* Label_SHUTDOWN PROGMEM = "выкл автомат";
const char* Label_PWM_START PROGMEM = "Мощн. старта";
const char* Label_FAN PROGMEM = "вентилятора ";
const char* Label_TIME_START PROGMEM = "Время разгона";
const char* Label_TIME_STOP PROGMEM = "Время остан.";
const char* Label_MIN PROGMEM = "мин";
//===============================================================================
...
void OutPercent(uint8_t value);		//вывод на дисплей значений мощности вентиляторов
