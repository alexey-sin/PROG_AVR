...
set C_FLAGS= -mmcu=%MCU% -I. -I%SRC_FILES% -DF_CPU=%F_CPU%UL -O%OPT% -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums -Wall -Wstrict-prototypes -std=gnu99 -MMD -MP
